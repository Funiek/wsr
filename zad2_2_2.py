...
spark = SparkSession.builder.master("spark://grid-1:7077").appName("passat2000destructor").getOrCreate()
...
## SPRAWDZ NA NASTEPNYCH BO WYNIKI SA PODOBNE I MOZE ZLE JEST
